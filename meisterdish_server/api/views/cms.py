    ...
    try:
        ...
        for user in users.object_list:
            user_list.append({
                              ...
                              "email" : user.email,
                              "mobile" : "Not Available" if str(user.mobile).strip() == "" else user.mobile,
    ...
    try:
        ...
        for user in users.object_list:
            user_list.append({
                              ...
                              "name" : (user.last_name + " "+ user.first_name).title(),
                              "email" : user.email,
                              "mobile" : "Not Available" if str(user.mobile) == "" else user.mobile,
                              "profile_image" : "Not Available" if str(user.profile_image) == "" else settings.MEDIA_URL + str(user.profile_image),
                              "is_admin":True if user.role.id == 1 else False,
                              "credits" : user.credits,
                              "is_active": user.is_active,
                              })
