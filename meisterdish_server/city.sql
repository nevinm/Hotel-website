...
CREATE TABLE meisterdish_server_city (
    id integer NOT NULL,
...
ALTER TABLE public.meisterdish_server_city OWNER TO umeisterdish;

--
-- Name: meisterdish_server_city_id_seq; Type: SEQUENCE; Schema: public; Owner: umeisterdish
--

CREATE SEQUENCE meisterdish_server_city_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.meisterdish_server_city_id_seq OWNER TO umeisterdish;

--
-- Name: meisterdish_server_city_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: umeisterdish
--
...
ALTER TABLE ONLY meisterdish_server_city
    ADD CONSTRAINT meisterdish_server_city_pkey PRIMARY KEY (id);


--
-- Name: meisterdish_server_city_d5582625; Type: INDEX; Schema: public; Owner: umeisterdish; Tablespace: 
--

CREATE INDEX meisterdish_server_city_d5582625 ON meisterdish_server_city USING btree (state_id);


--
-- Name: meisterdish_server_city_name_4f5ad548fa964622_uniq; Type: INDEX; Schema: public; Owner: umeisterdish; Tablespace: 
--

CREATE INDEX meisterdish_server_city_name_4f5ad548fa964622_uniq ON meisterdish_server_city USING btree (name);


--
-- Name: meisterdish_server_city_state_id; Type: INDEX; Schema: public; Owner: umeisterdish; Tablespace: 
--

CREATE INDEX meisterdish_server_city_state_id ON meisterdish_server_city USING btree (state_id);


--
-- Name: meisterdish_server_city_state_id_like; Type: INDEX; Schema: public; Owner: umeisterdish; Tablespace: 
--

CREATE INDEX meisterdish_server_city_state_id_like ON meisterdish_server_city USING btree (state_id varchar_pattern_ops);


--
-- Name: meisterdish_server_city_state_id_4668b5d16f82e04e_fk_meisterdis; Type: FK CONSTRAINT; Schema: public; Owner: umeisterdish
--

ALTER TABLE ONLY meisterdish_server_city
    ADD CONSTRAINT meisterdish_server_city_state_id_4668b5d16f82e04e_fk_meisterdis FOREIGN KEY (state_id) REFERENCES meisterdish_server_state(state_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: state_id_refs_state_code_4ec7040; Type: FK CONSTRAINT; Schema: public; Owner: umeisterdish
--

ALTER TABLE ONLY meisterdish_server_city
    ADD CONSTRAINT state_id_refs_state_code_4ec7040 FOREIGN KEY (state_id) REFERENCES meisterdish_server_state(state_code) DEFERRABLE INITIALLY DEFERRED;
