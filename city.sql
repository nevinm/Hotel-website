...
--
-- Name: api_city; Type: TABLE; Schema: public; Owner: afmp1; Tablespace: 
--
...
ALTER TABLE public.api_city OWNER TO afmp1;

--
-- Name: api_city_id_seq; Type: SEQUENCE; Schema: public; Owner: afmp1
--

CREATE SEQUENCE api_city_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.api_city_id_seq OWNER TO afmp1;

--
-- Name: api_city_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: afmp1
--

ALTER SEQUENCE api_city_id_seq OWNED BY api_city.id;


--
-- Name: api_country; Type: TABLE; Schema: public; Owner: afmp1; Tablespace: 
--
...
ALTER TABLE public.api_country OWNER TO afmp1;

--
-- Name: api_country_id_seq; Type: SEQUENCE; Schema: public; Owner: afmp1
--

CREATE SEQUENCE api_country_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.api_country_id_seq OWNER TO afmp1;

--
-- Name: api_country_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: afmp1
--

ALTER SEQUENCE api_country_id_seq OWNED BY api_country.id;


--
-- Name: api_state; Type: TABLE; Schema: public; Owner: afmp1; Tablespace: 
--
...
ALTER TABLE public.api_state OWNER TO afmp1;

--
-- Name: api_state_id_seq; Type: SEQUENCE; Schema: public; Owner: afmp1
--

CREATE SEQUENCE api_state_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.api_state_id_seq OWNER TO afmp1;

--
-- Name: api_state_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: afmp1
--

ALTER SEQUENCE api_state_id_seq OWNED BY api_state.id;


--
-- Name: id; Type: DEFAULT; Schema: public; Owner: afmp1
--

ALTER TABLE ONLY api_city ALTER COLUMN id SET DEFAULT nextval('api_city_id_seq'::regclass);
...
ALTER TABLE ONLY api_country ALTER COLUMN id SET DEFAULT nextval('api_country_id_seq'::regclass);
...
ALTER TABLE ONLY api_state ALTER COLUMN id SET DEFAULT nextval('api_state_id_seq'::regclass);


--
-- Data for Name: api_city; Type: TABLE DATA; Schema: public; Owner: afmp1
--

COPY api_city (id, name, state_id) FROM stdin;
1	Aaronsburg	PA
2	Abbeville	AL
3	Abbeville	GA
4	Abbeville	LA
...
4387	Cedar Point	IL
4388	Cedar Point	KS
4389	Cedar Rapids	IA
4390	Cedar Rapids	NE
4391	Cedar Ridge	CA
4392	Cedar Run	PA
...
10595	Grand Rapids	MI
10596	Grand Rapids	MN
10597	Grand Rapids	OH
...
22003	Rapid City	MI
22004	Rapid City	SD
22005	Rapid River	MI
22006	Rapidan	VA
22007	Rapids City	IL
...
--
-- Name: api_city_id_seq; Type: SEQUENCE SET; Schema: public; Owner: afmp1
--

SELECT pg_catalog.setval('api_city_id_seq', 29645, true);


--
-- Data for Name: api_country; Type: TABLE DATA; Schema: public; Owner: afmp1
--

COPY api_country (id, name, country_code) FROM stdin;
1	USA	US
\.


--
-- Name: api_country_id_seq; Type: SEQUENCE SET; Schema: public; Owner: afmp1
--

SELECT pg_catalog.setval('api_country_id_seq', 1, true);


--
-- Data for Name: api_state; Type: TABLE DATA; Schema: public; Owner: afmp1
--

COPY api_state (id, name, country_id, state_code) FROM stdin;
51	Alaska	US	AK
52	Alabama	US	AL
53	Arkansas	US	AR
54	Arizona	US	AZ
55	California	US	CA
56	Colorado	US	CO
57	Connecticut	US	CT
58	District of Columbia	US	DC
59	Delaware	US	DE
60	Florida	US	FL
61	Georgia	US	GA
62	Hawaii	US	HI
...
68	Kentucky	US	KY
69	Louisiana	US	LA
70	Massachusetts	US	MA
71	Maryland	US	MD
72	Maine	US	ME
73	Michigan	US	MI
74	Minnesota	US	MN
75	Missouri	US	MO
76	Mississippi	US	MS
77	Montana	US	MT
78	North Carolina	US	NC
79	North Dakota	US	ND
80	Nebraska	US	NE
81	New Hampshire	US	NH
82	New Jersey	US	NJ
83	New Mexico	US	NM
84	Nevada	US	NV
85	New York	US	NY
...
87	Oklahoma	US	OK
88	Oregon	US	OR
89	Pennsylvania	US	PA
90	Rhode Island	US	RI
91	South Carolina	US	SC
92	South Dakota	US	SD
93	Tennessee	US	TN
94	Texas	US	TX
95	Utah	US	UT
96	Virginia	US	VA
...
98	Washington	US	WA
99	Wisconsin	US	WI
100	West Virginia	US	WV
101	Wyoming	US	WY
\.


--
-- Name: api_state_id_seq; Type: SEQUENCE SET; Schema: public; Owner: afmp1
--

SELECT pg_catalog.setval('api_state_id_seq', 101, true);


--
-- Name: api_city_pkey; Type: CONSTRAINT; Schema: public; Owner: afmp1; Tablespace: 
--

ALTER TABLE ONLY api_city
    ADD CONSTRAINT api_city_pkey PRIMARY KEY (id);


--
-- Name: api_country_country_code_key; Type: CONSTRAINT; Schema: public; Owner: afmp1; Tablespace: 
--

ALTER TABLE ONLY api_country
    ADD CONSTRAINT api_country_country_code_key UNIQUE (country_code);


--
-- Name: api_country_pkey; Type: CONSTRAINT; Schema: public; Owner: afmp1; Tablespace: 
--
...
--
-- Name: api_state_pkey; Type: CONSTRAINT; Schema: public; Owner: afmp1; Tablespace: 
--

ALTER TABLE ONLY api_state
    ADD CONSTRAINT api_state_pkey PRIMARY KEY (id);


--
-- Name: api_state_state_code_key; Type: CONSTRAINT; Schema: public; Owner: afmp1; Tablespace: 
--

ALTER TABLE ONLY api_state
    ADD CONSTRAINT api_state_state_code_key UNIQUE (state_code);


--
-- Name: api_city_state_id; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_city_state_id ON api_city USING btree (state_id);


--
-- Name: api_city_state_id_like; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_city_state_id_like ON api_city USING btree (state_id varchar_pattern_ops);


--
-- Name: api_country_country_code_like; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_country_country_code_like ON api_country USING btree (country_code varchar_pattern_ops);


--
-- Name: api_state_country_id; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_state_country_id ON api_state USING btree (country_id);


--
-- Name: api_state_country_id_like; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_state_country_id_like ON api_state USING btree (country_id varchar_pattern_ops);


--
-- Name: api_state_state_code_like; Type: INDEX; Schema: public; Owner: afmp1; Tablespace: 
--

CREATE INDEX api_state_state_code_like ON api_state USING btree (state_code varchar_pattern_ops);


--
-- Name: country_id_refs_country_code_257b4750; Type: FK CONSTRAINT; Schema: public; Owner: afmp1
--

ALTER TABLE ONLY api_state
    ADD CONSTRAINT country_id_refs_country_code_257b4750 FOREIGN KEY (country_id) REFERENCES api_country(country_code) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: state_id_refs_state_code_4ec7040; Type: FK CONSTRAINT; Schema: public; Owner: afmp1
--

ALTER TABLE ONLY api_city
    ADD CONSTRAINT state_id_refs_state_code_4ec7040 FOREIGN KEY (state_id) REFERENCES api_state(state_code) DEFERRABLE INITIALLY DEFERRED;
