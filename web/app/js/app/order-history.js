...
OrderHistoryController.prototype = function () {
    ...
    var populateOrdersList = function (ordersList) {
    ...
    return {
        checkFromPaypal:checkFromPaypal
    };
}();
$(document).ready(function () {
    var orderHistory = new OrderHistoryController();
    orderHistory.checkFromPaypal();
    // &ACCORDION
